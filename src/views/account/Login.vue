            ...
            <div class="bg-primary">
              <div class="text-primary text-center p-4">
                <h5 class="text-white font-size-20">
                  Welcome To FacitilitaPay !
                </h5>
                <p class="text-white-50">
                  Sign in to continue to FacitilitaPay.
                </p>
              ...
              <div class="p-3">
                ...
                >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6 text-right offset-6">
                      <b-button
type="submit"
variant="primary"
class="w-md"
          ...
          <div class="mt-5 text-center">
            ...
            <p class="mb-0">
              ©
              {{ new Date().getFullYear() }} FacitilitaPay. Crafted with
              <i class="mdi mdi-heart text-danger"></i> by NeoSoft
            </p>
          </div>
        </div>
        <!-- end col -->
